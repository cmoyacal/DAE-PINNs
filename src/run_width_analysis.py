...
from utils.plots import plot_width_analysis
...
def main(args):
    ...
    for k in range(len(width)):
        ...
        train_width[k] = state.best_loss_train
        test_width[k] = state.best_loss_test

    # plot results
    print("plotting results...\n")
    plot_width_analysis(width, train_width, test_width, fname=os.path.join(args.log_dir,'width-analysis.png'))

    # save the results for future use
    np.savez(os.path.join(args.log_dir, "width-data"), width=width, train=train_width, test=test_width)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="width-analysis")
