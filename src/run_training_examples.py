...
if __name__ == "__main__":
    ...
    parser.add_argument('--log-dir', type=str, default="./logs/dae-pinns-num-train-analysis/", help="log dir")
    ...
    parser.add_argument('--num-test', type=int, default=1000, help="number of test examples")
